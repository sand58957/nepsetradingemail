...
export const telegramService = {
  ...
  getSettings: async (): Promise<{
    data: { configured: boolean; settings?: TelegramSettings; bot_username?: string }
  }> => {
  ...
  createContact: async (
    data: Partial<TelegramContact> & { group_ids?: number[] }
  ): Promise<{ data: TelegramContact }> => {
  ...
  createGroup: async (data: {
    ...
    description?: string
    color?: string
  }): Promise<{ data: TelegramContactGroup }> => {
