...
export const messengerService = {
  ...
  getSettings: async (): Promise<{
    data: { configured: boolean; settings?: MessengerSettings; page_name?: string }
  }> => {
  ...
  createContact: async (
    data: Partial<MessengerContact> & { group_ids?: number[] }
  ): Promise<{ data: MessengerContact }> => {
  ...
  createGroup: async (data: {
    ...
    description?: string
    color?: string
  }): Promise<{ data: MessengerContactGroup }> => {
