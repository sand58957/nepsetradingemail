    ...
    <Card>
      ...
      <CardContent>
        <Alert severity='info' className='mb-4'>
          Custom fields are automatically detected from contact attributes. You can set attributes when creating/editing
          contacts or via CSV import. Use these fields as template variables in your campaigns.
        </Alert>
