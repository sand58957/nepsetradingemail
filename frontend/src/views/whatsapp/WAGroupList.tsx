...
import type { WAContactGroupWithCount } from '@/types/whatsapp'

const COLOR_OPTIONS = ['#25D366', '#1976d2', '#388e3c', '#d32f2f', '#f57c00', '#7b1fa2', '#0097a7', '#455a64']
...
const WAGroupList = () => {
  ...
  const [groups, setGroups] = useState<WAContactGroupWithCount[]>([])
    ...
    <>
      <Card>
        <CardHeader
          ...
          subheader='Organize your WhatsApp contacts into groups for targeted campaigns'
          action={
