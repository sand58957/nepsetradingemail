...
// Type Imports
import type { MessengerCampaign } from '@/types/messenger'
...
const MessengerCampaignList = () => {
  ...
  const [menuCampaign, setMenuCampaign] = useState<MessengerCampaign | null>(null)
  ...
  const fetchCampaigns = useCallback(async () => {
    ...
    try {
      const response = await messengerService.getCampaigns({
        page: page + 1,
  ...
  const handleDelete = async () => {
    ...
    try {
      await messengerService.deleteCampaign(deletingId)
  ...
  const getDeliveryRate = (campaign: MessengerCampaign) => {
...
export default MessengerCampaignList
