...
export const BlockMiniPreview = ({ previewKey }: { previewKey: string }) => {
  ...
  const socialDots = (
    <Box sx={{ display: 'flex', gap: 0.5 }}>
      {[1, 2, 3].map(n => (
        <Box key={n} sx={{ width: 10, height: 10, bgcolor: '#9e9e9e', borderRadius: '50%' }} />
      ))}
    </Box>
  )
  ...
  switch (previewKey) {
      ...
      return (
        <Box sx={{ display: 'flex', gap: 1 }}>
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Typography sx={{ fontWeight: 700, fontSize: '0.7rem', lineHeight: 1.2, mb: 0.3 }}>
      ...
      return (
        <Box>
          <Box sx={{ display: 'flex', gap: 1, mb: 0.8 }}>
            <Box sx={{ flex: 1 }}>
              <Typography sx={{ fontWeight: 700, fontSize: '0.7rem', lineHeight: 1.2 }}>
                Introduce your concept
              </Typography>
            </Box>
            <Box sx={{ flex: 1 }}>
    ...
    case 'sec-1col':
      return (
        <Box sx={{ border: '1px dashed #e0e0e0', borderRadius: 0.5, p: 1, textAlign: 'center' }}>
    ...
    case 'sec-2col':
      return (
        <Box sx={{ display: 'flex', gap: 1 }}>
          <Box sx={{ flex: 1, border: '1px dashed #e0e0e0', borderRadius: 0.5, p: 1, textAlign: 'center' }}>
            <Typography variant='caption' color='text.disabled'>
              1
            </Typography>
          </Box>
    ...
    case 'sec-3col':
      return (
        <Box sx={{ display: 'flex', gap: 1 }}>
          {[1, 2, 3].map(n => (
            <Box key={n} sx={{ flex: 1, border: '1px dashed #e0e0e0', borderRadius: 0.5, p: 1, textAlign: 'center' }}>
              <Typography variant='caption' color='text.disabled'>
                {n}
              </Typography>
            </Box>
    ...
    case 'sec-1-2':
      return (
        <Box sx={{ display: 'flex', gap: 1 }}>
          ...
          <Box sx={{ flex: 2, border: '1px dashed #e0e0e0', borderRadius: 0.5, p: 1, textAlign: 'center' }}>
            <Typography variant='caption' color='text.disabled'>
              2
            </Typography>
          </Box>
    ...
    case 'sec-sidebar-l':
      return (
        <Box sx={{ display: 'flex', gap: 1 }}>
          <Box sx={{ width: 60, border: '1px dashed #e0e0e0', borderRadius: 0.5, p: 1, textAlign: 'center' }}>
            <Typography variant='caption' color='text.disabled'>
              Side
            </Typography>
          </Box>
      ...
      return (
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', py: 0.5 }}>
          ...
          <Box sx={{ bgcolor: '#333', borderRadius: 0.5, px: 1, py: 0.3 }}>
            <Typography sx={{ color: '#fff', fontSize: '0.5rem' }}>More</Typography>
          </Box>
        </Box>
      )
    case 'el-text':
    ...
    case 'el-video':
      return (
        ...
        >
          <i className='tabler-player-play text-[22px]' style={{ color: '#c0c0c0' }} />
        </Box>
      )
    case 'el-audio':
      return (
    ...
    case 'el-table':
      return (
        <Box sx={{ py: 0.5 }}>
          <Typography sx={{ fontWeight: 600, fontSize: '0.6rem', textAlign: 'center', mb: 0.5 }}>
            ...
            {['60%', '40%', '25%'].map((v, i) => (
              <Box key={i} sx={{ flex: 1, textAlign: 'center' }}>
                <Box
                  sx={{
                    height: [18, 12, 8][i],
                    bgcolor: ['#4caf50', '#66bb6a', '#81c784'][i],
                    borderRadius: 0.5,
                    mb: 0.3
                  }}
                />
      ...
      return (
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.3, py: 0.5 }}>
          {['Read article', 'Read article', 'Read article'].map((t, i) => (
            <Typography key={i} sx={{ fontSize: '0.55rem', color: '#4caf50', textDecoration: 'underline' }}>
              {t}
            </Typography>
          ))}
        </Box>
    ...
    case 'cnt-message':
      return (
        ...
        >
          <Typography sx={{ fontSize: '0.5rem', color: '#fff', fontWeight: 500 }}>
            Don&apos;t miss our Cyber Week Sale!
          </Typography>
    ...
    case 'cnt-basic-cta':
      return (
        <Box sx={{ textAlign: 'center', py: 0.5 }}>
          <Typography sx={{ fontWeight: 700, fontSize: '0.65rem', mb: 0.3 }}>
      ...
      return (
        <Box sx={{ py: 0.5 }}>
          ...
          <Typography sx={{ fontSize: '0.45rem', color: '#999', lineHeight: 1.3, mb: 0.6 }}>
            Get your creative juices flowing. Write engaging and informative content that will help your readers
    ...
    case 'sp-banner':
      return (
        <Box sx={{ bgcolor: '#fff3e0', borderRadius: 0.5, p: 1, textAlign: 'center' }}>
          <Box sx={{ ...pillStyle, width: '60%', mx: 'auto' }} />
        </Box>
      )
    case 'sp-coupon':
      return (
        <Box sx={{ border: '2px dashed #e0e0e0', borderRadius: 1, p: 1, textAlign: 'center' }}>
          ...
          {[1, 2].map(n => (
            <Box key={n} sx={{ flex: 1, textAlign: 'center' }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.3, mb: 0.3 }}>
                ...
                <Typography sx={{ fontSize: '0.35rem', color: '#999', textDecoration: 'line-through' }}>
                  $149
                </Typography>
              </Box>
      ...
      return (
        <Box sx={{ bgcolor: '#f5f5f5', borderRadius: 1, p: 1, textAlign: 'center' }}>
          ...
          <Box sx={{ bgcolor: '#4caf50', borderRadius: 0.5, px: 1.5, py: 0.3, display: 'inline-block', mb: 0.3 }}>
            <Typography sx={{ fontSize: '0.5rem', color: '#fff', fontWeight: 700, letterSpacing: 1 }}>
              DISC50
            </Typography>
          </Box>
        ...
        <Box sx={{ bgcolor: '#f5f5f5', borderRadius: 1, p: 0.8, display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Box sx={{ bgcolor: '#4caf50', borderRadius: 0.5, px: 1, py: 0.3 }}>
              <Typography sx={{ fontSize: '0.45rem', color: '#fff', fontWeight: 700, letterSpacing: 1 }}>
                DISC50
              </Typography>
            </Box>
          </Box>
    ...
    case 'blog-extended':
      return (
        <Box sx={{ py: 0.5 }}>
          ...
          <Typography sx={{ fontSize: '0.4rem', color: '#999', mb: 0.4 }}>
            Use this space to introduce subscribers to the topic of this newsletter.
          </Typography>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 0.5 }}>
            <Box sx={{ width: 12, height: 12, borderRadius: '50%', bgcolor: '#e0e0e0' }} />
            <Box>
              <Typography sx={{ fontSize: '0.35rem', fontWeight: 600 }}>Author name</Typography>
              <Typography sx={{ fontSize: '0.3rem', color: '#999' }}>Jan 18</Typography>
            </Box>
          </Box>
          <Box
            sx={{
          ...
          <Typography sx={{ fontSize: '0.35rem', color: '#999', lineHeight: 1.3, mb: 0.3 }}>
            Get your creative juices flowing. Write engaging and informative content that will help your readers
            understand your message.
          </Typography>
      ...
      return (
        <Box sx={{ display: 'flex', gap: 0.8 }}>
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Typography sx={{ fontSize: '0.4rem', color: '#4caf50', textDecoration: 'underline' }}>
              Read more
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 0.5 }}>
          {[1, 2].map(n => (
            <Box key={n} sx={{ flex: 1 }}>
              ...
              <Typography sx={{ fontSize: '0.3rem', color: '#999', lineHeight: 1.3, mb: 0.2 }}>
                Write engaging and informative content that will help your readers understand your message.
              </Typography>
              <Typography sx={{ fontSize: '0.35rem', color: '#4caf50', textDecoration: 'underline' }}>
                Read more
              </Typography>
            </Box>
          ))}
          ...
          {[1, 2].map(n => (
            <Box key={n} sx={{ flex: 1, display: 'flex', gap: 0.5 }}>
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <Typography sx={{ fontSize: '0.28rem', color: '#999', lineHeight: 1.2, mb: 0.1 }}>
                  Write engaging and informative content.
                </Typography>
                <Typography sx={{ fontSize: '0.3rem', color: '#4caf50', textDecoration: 'underline' }}>
                  Read more
                </Typography>
              </Box>
            </Box>
      ...
      return (
        <Box sx={{ py: 0.5 }}>
          <Typography sx={{ fontSize: '0.38rem', color: '#555', fontStyle: 'italic', lineHeight: 1.3, mb: 0.5 }}>
            &ldquo;Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam platea fusce eget viverra integer
            et.&rdquo;
          </Typography>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
            <Box sx={{ width: 16, height: 16, borderRadius: '50%', bgcolor: '#e0e0e0' }} />
            <Box>
              <Typography sx={{ fontSize: '0.4rem', fontWeight: 600 }}>Fabricio Texeira</Typography>
              <Typography sx={{ fontSize: '0.3rem', color: '#999' }}>Jan 18</Typography>
            </Box>
          </Box>
        </Box>
      ...
      return (
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.8, py: 0.5 }}>
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Typography sx={{ fontSize: '0.35rem', color: '#999', lineHeight: 1.3 }}>
              Write engaging and informative content that will help your readers understand your message.
            </Typography>
          </Box>
        </Box>
    ...
    case 'blog-rss':
      return (
        <Box sx={{ py: 0.5 }}>
          <Typography sx={{ fontWeight: 700, fontSize: '0.5rem', mb: 0.2 }}>
            NASA, Rocket Lab Announce Coverage for Second TROPICS Launch
          </Typography>
          <Typography sx={{ fontSize: '0.35rem', color: '#999', lineHeight: 1.3 }}>
            After successfully launching the first pair of small satellites earlier this month from New Zealand, NASA
            and Rocket Lab are now targeting no earlier than...
          </Typography>
        </Box>
      )
    case 'soc-links':
    ...
    case 'soc-facebook':
      return (
        <Box sx={{ border: '1px solid #e0e0e0', borderRadius: 0.5, overflow: 'hidden' }}>
          ...
          <Typography sx={{ fontSize: '0.35rem', color: '#555', px: 0.8, py: 0.3, lineHeight: 1.3 }}>
            Our team is so scattered across the globe, it&apos;s hard to keep track of where we&apos;re all working
            from!
          </Typography>
          ...
          <Box sx={{ display: 'flex', gap: 1, px: 0.8, py: 0.3 }}>
            {['Like', 'Comment', 'Share'].map(a => (
              <Typography key={a} sx={{ fontSize: '0.3rem', color: '#999' }}>
                {a}
              </Typography>
            ))}
          </Box>
    ...
    case 'ftr-centered':
      return (
        <Box sx={{ textAlign: 'center', bgcolor: '#f5f5f5', borderRadius: 0.5, p: 1 }}>
          ...
          <Typography sx={{ fontSize: '0.3rem', color: '#999', lineHeight: 1.3, mb: 0.3 }}>
        ...
        <Box sx={{ bgcolor: '#f5f5f5', borderRadius: 0.5, overflow: 'hidden' }}>
          ...
          <Box sx={{ bgcolor: '#333', px: 1, py: 0.3, display: 'flex', justifyContent: 'center', gap: 1 }}>
            {['About', 'News', 'Shop'].map(t => (
              <Typography key={t} sx={{ fontSize: '0.35rem', color: '#fff' }}>
                {t}
              </Typography>
            ))}
          </Box>
    ...
    case 'ftr-app':
      return (
        <Box sx={{ bgcolor: '#f5f5f5', borderRadius: 0.5, p: 1, textAlign: 'center' }}>
          ...
          <Typography sx={{ fontSize: '0.3rem', color: '#999', lineHeight: 1.3, mb: 0.4 }}>
            You received this email because you signed up on our website or made a purchase from us.
          </Typography>
...
export const blockRowTemplates: Record<string, any> = {
  ...
  logo: {
    ...
    values: { backgroundColor: '#ffffff', padding: '10px 20px' }
  },
  nav: {
    cells: [1],
    columns: [
      {
        contents: [
          {
            type: 'menu',
            values: { layout: 'horizontal', separator: '|', align: 'center', fontSize: '14px', padding: '10px 20px' }
          }
        ]
      }
    ],
    values: { backgroundColor: '#ffffff', padding: '5px 20px' }
  },
  'logo-nav-center': {
    cells: [1, 1],
    columns: [
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Logo', width: '120px' } }] },
      { contents: [{ type: 'menu', values: { layout: 'horizontal', align: 'right', fontSize: '14px' } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '10px 20px' }
  },
  'logo-nav-row': {
  ...
  'logo-social': {
    ...
    columns: [
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Logo', width: '120px' } }] },
      { contents: [{ type: 'social', values: { align: 'right', icons: { iconType: 'circle' } } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '10px 20px' }
  },
  'logo-text': {
    ...
    columns: [
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Logo', width: '120px' } }] },
      {
        contents: [
          {
            type: 'text',
            values: { text: '<p style="text-align:right;font-size:14px;color:#666;">Weekly Newsletter</p>' }
          }
        ]
      }
    ],
  ...
  'hero-standard': {
    ...
    columns: [
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Hero Image', width: '100%', fullWidth: true } },
          {
            type: 'heading',
            values: { text: 'Introduce your concept', fontSize: '28px', textAlign: 'center', padding: '10px 20px 5px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;color:#666;">Use this space to introduce subscribers to the topic of this newsletter. If you\'re selling something, write informative and persuasive copy to effectively communicate your message.</p>',
    ...
    values: { backgroundColor: '#ffffff', padding: '0px 0px 20px' }
  },
  'hero-extended': {
    cells: [1],
    columns: [
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Product Image', width: '100%', fullWidth: true } },
          {
            type: 'heading',
            values: { text: 'Product name', fontSize: '24px', textAlign: 'center', padding: '10px 20px 5px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;color:#666;">Describe your product in a way that highlights how it will benefit your readers.</p>',
          ...
          },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;"><strong style="font-size:20px;">$99</strong> <span style="text-decoration:line-through;color:#999;">$199</span></p>',
    ...
    columns: [
      {
        contents: [
          ...
          { type: 'image', values: { src: { url: '' }, alt: 'Hero Image', width: '100%' } },
          {
            type: 'heading',
            values: { text: 'Compelling headline', fontSize: '20px', textAlign: 'center', padding: '10px 20px 5px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;color:#666;">Get your creative juices flowing. Write engaging and informative content that will help your readers understand your message.</p>',
              padding: '0px 40px 10px'
            }
          },
          {
  ...
  'hero-side-by-side': {
    cells: [1, 1],
    columns: [
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Hero Image', width: '100%' } }] },
      {
        contents: [
          {
            type: 'text',
            values: { text: '<p style="color:#999;font-size:13px;">Subtitle</p>', padding: '10px 20px 0px' }
          },
          { type: 'heading', values: { text: 'Introduce your concept', fontSize: '22px', padding: '5px 20px' } },
          {
            type: 'text',
            values: {
              text: '<p style="color:#666;">Use this space to introduce subscribers to the topic of this newsletter.</p>',
  ...
  'hero-img-below': {
    ...
    columns: [
      {
        contents: [
          {
            type: 'heading',
            values: { text: 'Introduce your concept', fontSize: '24px', fontWeight: 700, padding: '10px 20px' }
          }
        ]
      },
      {
    ...
    values: { backgroundColor: '#ffffff', padding: '10px 0px 0px' }
  },

  // Sections
  'sec-1col': {
    cells: [1],
    columns: [{ contents: [{ type: 'text', values: { text: '<p>Content goes here</p>' } }] }],
    values: { backgroundColor: '#ffffff', padding: '20px' }
  },
  'sec-2col': {
    cells: [1, 1],
    columns: [
      { contents: [{ type: 'text', values: { text: '<p>Column 1</p>' } }] },
      { contents: [{ type: 'text', values: { text: '<p>Column 2</p>' } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '20px' }
  },
  'sec-3col': {
    cells: [1, 1, 1],
    columns: [
      { contents: [{ type: 'text', values: { text: '<p>Col 1</p>' } }] },
      { contents: [{ type: 'text', values: { text: '<p>Col 2</p>' } }] },
      { contents: [{ type: 'text', values: { text: '<p>Col 3</p>' } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '20px' }
  },
  'sec-1-2': {
    cells: [1, 2],
    columns: [
      { contents: [{ type: 'text', values: { text: '<p>Narrow</p>' } }] },
      { contents: [{ type: 'text', values: { text: '<p>Wide column</p>' } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '20px' }
  },
  'sec-2-1': {
  ...
  'sec-sidebar-l': {
    cells: [1, 2],
    columns: [
      { contents: [{ type: 'text', values: { text: '<p>Sidebar</p>' } }] },
      { contents: [{ type: 'text', values: { text: '<p>Main content area</p>' } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '20px' }
  },
  ...
  'el-spacer': {
    ...
    columns: [
      {
        contents: [
          { type: 'divider', values: { width: '100%', border: { borderTopWidth: '0px' }, padding: '30px 0px' } }
        ]
      }
    ],
  ...
  'el-title': {
    cells: [1],
    columns: [
      { contents: [{ type: 'heading', values: { text: 'Compelling headline', fontSize: '24px', fontWeight: 700 } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '10px 20px' }
  },
  'el-title-btn': {
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<p style="color:#666;">Write engaging and informative content that will help your readers understand your message.</p>'
            }
          }
        ]
      }
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<blockquote style="border-left:3px solid #ccc;padding-left:15px;margin:0;color:#555;font-style:italic;">Write your quote here.</blockquote>'
            }
          }
        ]
      }
    ],
    values: { backgroundColor: '#ffffff', padding: '15px 20px' }
  },
  'el-button': {
    cells: [1],
    columns: [
  ...
  'el-image': {
    cells: [1],
    columns: [{ contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image', width: '100%' } }] }],
    values: { backgroundColor: '#ffffff', padding: '10px 20px' }
  },
  'el-video': {
    cells: [1],
    columns: [
      {
        contents: [
          {
            type: 'image',
            values: { src: { url: '' }, alt: 'Video thumbnail - click to add video URL', width: '100%' }
          }
        ]
      }
    ],
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<table cellpadding="0" cellspacing="0" style="width:100%;"><tr><td style="width:50px;"><div style="width:40px;height:40px;background:#f0f0f0;border-radius:4px;text-align:center;line-height:40px;">&#9835;</div></td><td style="padding-left:10px;"><strong>Artist name</strong><br/><span style="color:#999;font-size:13px;">Audio title</span></td><td style="width:40px;text-align:right;font-size:20px;">▶</td></tr></table>'
            }
          }
        ]
      }
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<p><a href="#" style="color:#4caf50;">Read article</a></p><p><a href="#" style="color:#4caf50;">Read article</a></p><p><a href="#" style="color:#4caf50;">Read article</a></p>'
            }
          }
        ]
      }
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<div style="background-color:#4caf50;padding:12px 20px;border-radius:4px;text-align:center;"><span style="color:#ffffff;font-size:14px;">Don\'t miss our Cyber Week Sale! <a href="#" style="color:#ffffff;text-decoration:underline;">learn more</a></span></div>'
            }
          }
        ]
      }
  ...
  'cnt-mini-box-cta': {
    ...
    columns: [
      {
        contents: [
          { type: 'text', values: { text: '<p style="font-size:14px;">Don\'t miss our Cyber Week Sale!</p>' } }
        ]
      },
      {
        contents: [
          {
            type: 'button',
            values: { text: 'Button', backgroundColor: '#333333', color: '#ffffff', borderRadius: '4px' }
          }
        ]
      }
    ],
        ...
        contents: [
          {
            type: 'heading',
            values: {
              text: 'Sign up for the full experience',
              fontSize: '22px',
              textAlign: 'center',
          ...
          },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;color:#666;font-size:14px;">You\'re on the free list for The Line Between. For the full experience, become a paying member.</p>',
              padding: '0 40px 10px'
            }
          },
          {
            type: 'button',
            values: { text: 'Button', backgroundColor: '#4caf50', color: '#ffffff', borderRadius: '4px' }
          }
        ]
      }
    ],
  ...
  'cnt-box-cta': {
    ...
    values: { backgroundColor: '#f9f9f9', padding: '30px 20px', borderRadius: '8px' }
  },
  'cnt-simple': {
    cells: [1],
    columns: [
      {
        contents: [
          {
            type: 'heading',
            values: { text: 'Compelling headline', fontSize: '24px', fontWeight: 700, padding: '10px 20px 5px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="color:#666;font-size:14px;">Get your creative juices flowing. Write engaging and informative content that will help your readers understand your message.</p>',
              padding: '0 20px 10px'
            }
          },
          {
    ...
    values: { backgroundColor: '#ffffff', padding: '10px 20px 20px' }
  },
  'cnt-box': {
    cells: [1],
    columns: [
    ...
    values: { backgroundColor: '#f9f9f9', padding: '20px', borderRadius: '8px' }
  },
  'cnt-img-simple': {
    cells: [1],
    columns: [
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Image', width: '100%' } },
          {
            type: 'heading',
            values: { text: 'Compelling headline', fontSize: '24px', fontWeight: 700, padding: '15px 20px 5px' }
          },
          {
            type: 'text',
            values: {
  ...
  'cnt-title-img': {
    ...
    columns: [
      {
        contents: [
          {
            type: 'heading',
            values: { text: 'Compelling headline', fontSize: '24px', fontWeight: 700, padding: '10px 20px 10px' }
          },
          { type: 'image', values: { src: { url: '' }, alt: 'Image', width: '100%' } },
          {
            type: 'text',
    ...
    values: { backgroundColor: '#ffffff', padding: '10px 0px 20px' }
  },
  'cnt-title-image': {
    cells: [1],
    columns: [
  ...
  'sp-timer': {
    ...
    columns: [
      {
        contents: [
          { type: 'timer', values: { expireDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString() } }
        ]
      }
    ],
    values: { backgroundColor: '#ffffff', padding: '20px' }
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;font-size:14px;">Limited Time Offer</p><p style="text-align:center;color:#d32f2f;font-weight:bold;font-size:18px;">Ends in 2 days!</p>'
            }
          }
        ]
      }
    ],
    values: { backgroundColor: '#fff3e0', padding: '20px' }
  },
  'sp-banner': {
    cells: [1],
    columns: [
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;font-weight:bold;font-size:16px;">Special Announcement Banner</p>'
            }
          }
        ]
      }
    ],
    values: { backgroundColor: '#fff3e0', padding: '15px 20px' }
  },
  'sp-coupon': {
    cells: [1],
    columns: [
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;font-size:14px;">Use code:</p><p style="text-align:center;font-size:28px;font-weight:bold;letter-spacing:4px;">SAVE20</p><p style="text-align:center;font-size:12px;color:#666;">Valid until end of month</p>'
            }
          }
        ]
      }
    ],
    values: { backgroundColor: '#ffffff', padding: '20px', borderRadius: '8px' }
  },
  ...
  'prod-import': {
    ...
    columns: [
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Product 1', width: '100%' } },
          {
            type: 'text',
            values: { text: '<p style="text-align:center;font-size:12px;color:#999;">&#9679; &#9679;</p>' }
          },
          {
            type: 'button',
            values: { text: 'Button', backgroundColor: '#4caf50', color: '#ffffff', borderRadius: '4px' }
      ...
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Product 2', width: '100%' } },
          {
            type: 'text',
            values: { text: '<p style="text-align:center;font-size:12px;color:#999;">&#9679; &#9679;</p>' }
          },
      ...
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Product 3', width: '100%' } },
          {
            type: 'text',
            values: { text: '<p style="text-align:center;font-size:12px;color:#999;">&#9679; &#9679;</p>' }
          },
    ...
    values: { backgroundColor: '#ffffff', padding: '15px 10px' }
  },
  'prod-1-vert': {
    cells: [1],
    columns: [
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Product', width: '100%' } },
          {
            type: 'heading',
            values: { text: 'Product name', fontSize: '20px', textAlign: 'center', padding: '10px 20px 5px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;color:#666;font-size:14px;">Describe your product in way that highlights how it will benefit your readers.</p><p style="text-align:center;margin-top:8px;"><strong style="font-size:18px;">$99</strong> <span style="text-decoration:line-through;color:#999;">$149</span></p>',
              padding: '0 20px 10px'
            }
          },
          {
  ...
  'prod-1-horiz': {
    cells: [1, 2],
    columns: [
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Product', width: '100%' } }] },
      {
        contents: [
          { type: 'heading', values: { text: 'Product name', fontSize: '20px', padding: '5px 10px' } },
          {
            type: 'text',
            values: {
              text: '<p style="color:#666;font-size:14px;">Describe your product in way that highlights how it will benefit your readers.</p><p style="margin-top:8px;"><strong style="font-size:18px;">$99</strong> <span style="text-decoration:line-through;color:#999;">$149</span></p>',
              padding: '0 10px 10px'
            }
          },
          {
    ...
    values: { backgroundColor: '#ffffff', padding: '15px' }
  },
  'prod-2': {
    cells: [1, 1],
    columns: [
      {
        contents: [
          ...
          {
            type: 'heading',
            values: { text: 'Product name', fontSize: '16px', textAlign: 'center', padding: '8px 5px 3px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;color:#666;font-size:13px;">Describe your product.</p><p style="text-align:center;margin-top:5px;"><strong>$99</strong> <span style="text-decoration:line-through;color:#999;font-size:12px;">$149</span></p>',
              padding: '0 5px 8px'
            }
          },
          {
  ...
  'prod-3': {
    ...
    columns: [
      {
        contents: [
          ...
          {
            type: 'heading',
            values: { text: 'Product name', fontSize: '14px', textAlign: 'center', padding: '5px 3px 2px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;color:#666;font-size:12px;">Describe your product.</p><p style="text-align:center;margin-top:4px;"><strong>$99</strong> <span style="text-decoration:line-through;color:#999;font-size:11px;">$149</span></p>',
              padding: '0 3px 5px'
            }
          },
          {
    ...
    values: { backgroundColor: '#ffffff', padding: '10px 5px' }
  },
  'prod-coupon-vert': {
    cells: [1],
    columns: [
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<div style="background:#f5f5f5;border-radius:8px 0 0 8px;padding:20px;"><p style="font-size:11px;color:#999;letter-spacing:2px;margin-bottom:4px;">DISCOUNT</p><p style="font-size:22px;font-weight:bold;margin-bottom:4px;">GET 50% OFF</p><p style="font-size:13px;color:#666;">On your next order.</p><p style="font-size:11px;color:#bbb;margin-top:6px;">*T&Cs apply*</p></div>'
            }
          }
        ]
      },
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<div style="background:#f5f5f5;border-radius:0 8px 8px 0;padding:20px;text-align:center;display:flex;flex-direction:column;justify-content:center;height:100%;"><p style="font-size:12px;color:#999;margin-bottom:8px;">Use code:</p><div style="display:inline-block;background:#4caf50;color:#fff;font-weight:bold;padding:8px 20px;border-radius:4px;letter-spacing:2px;font-size:14px;">DISC50</div></div>'
            }
          }
        ]
      }
  ...
  'gal-1': {
    cells: [1],
    columns: [
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image', width: '100%', fullWidth: true } }] }
    ],
  ...
  'gal-2': {
    cells: [1, 1],
    columns: [
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 1', width: '100%' } }] },
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 2', width: '100%' } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '10px' }
  },
  'gal-3': {
    ...
    columns: [
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 1', width: '100%' } }] },
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 2', width: '100%' } }] },
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 3', width: '100%' } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '10px' }
  },
  'gal-4': {
    ...
    columns: [
      ...
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 2', width: '100%' } }] },
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 3', width: '100%' } }] },
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 4', width: '100%' } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '10px' }
  },
  'gal-5': {
    ...
    columns: [
      ...
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 3', width: '100%' } }] },
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 4', width: '100%' } }] },
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Image 5', width: '100%' } }] }
    ],
    values: { backgroundColor: '#ffffff', padding: '10px' }
  },
  'gal-carousel': {
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<table cellpadding="0" cellspacing="4" style="width:100%;"><tr><td style="width:20%;"><div style="background:#f0f0f0;border-radius:4px;height:60px;"></div></td><td style="width:20%;"><div style="background:#f0f0f0;border-radius:4px;height:60px;"></div></td><td style="width:20%;"><div style="background:#f0f0f0;border-radius:4px;height:60px;"></div></td><td style="width:20%;"><div style="background:#f0f0f0;border-radius:4px;height:60px;"></div></td><td style="width:20%;"><div style="background:#f0f0f0;border-radius:4px;height:60px;"></div></td></tr></table>'
            }
          },
          { type: 'image', values: { src: { url: '' }, alt: 'Featured Image', width: '100%' } }
        ]
      }
    ],
    values: { backgroundColor: '#ffffff', padding: '10px' }
  ...
  'blog-extended': {
    ...
    columns: [
      {
        contents: [
          {
            type: 'heading',
            values: { text: 'Introduce your concept', fontSize: '24px', fontWeight: 700, padding: '10px 20px 5px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="color:#666;font-size:14px;">Use this space to introduce subscribers to the topic of this newsletter.</p>',
              padding: '0 20px 10px'
            }
          },
          {
            type: 'text',
            values: {
              text: '<table cellpadding="0" cellspacing="0"><tr><td style="width:30px;"><div style="width:24px;height:24px;background:#e0e0e0;border-radius:50%;"></div></td><td style="padding-left:8px;"><strong style="font-size:13px;">Author name</strong><br/><span style="color:#999;font-size:12px;">Jan 18</span></td></tr></table>',
              padding: '0 20px 10px'
            }
          },
          { type: 'image', values: { src: { url: '' }, alt: 'Blog Image', width: '100%' } },
          {
            type: 'text',
            values: {
              text: '<p style="color:#666;font-size:14px;">Get your creative juices flowing. Write engaging and informative content that will help your readers understand your message. Be concise, clear, and on-brand. Remember to proofread for grammar and spelling errors before publishing.</p><p style="margin-top:10px;"><a href="#" style="color:#4caf50;">Read more</a></p>',
    ...
    values: { backgroundColor: '#ffffff', padding: '0' }
  },
  'blog-basic': {
    cells: [1, 2],
    columns: [
      { contents: [{ type: 'image', values: { src: { url: '' }, alt: 'Blog Image', width: '100%' } }] },
      {
        contents: [
          {
            type: 'heading',
            values: { text: 'Compelling headline', fontSize: '20px', fontWeight: 700, padding: '5px 10px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="color:#666;font-size:14px;">Write engaging and informative content that will help your readers understand your message.</p><p style="margin-top:8px;"><a href="#" style="color:#4caf50;">Read more</a></p>',
              padding: '0 10px 10px'
            }
          }
        ]
  ...
  'blog-double': {
    ...
    columns: [
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Blog Image 1', width: '100%' } },
          {
            type: 'heading',
            values: { text: 'Compelling headline', fontSize: '18px', fontWeight: 700, padding: '8px 5px 3px' }
          },
          {
            type: 'text',
            values: {
              text: '<p style="color:#666;font-size:13px;">Write engaging and informative content that will help your readers understand your message.</p><p style="margin-top:6px;"><a href="#" style="color:#4caf50;">Read more</a></p>',
              padding: '0 5px 10px'
            }
          }
        ]
      ...
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Blog Image 2', width: '100%' } },
          {
            type: 'heading',
            values: { text: 'Compelling headline', fontSize: '18px', fontWeight: 700, padding: '8px 5px 3px' }
          },
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<table cellpadding="0" cellspacing="0" style="width:100%;"><tr><td style="width:80px;vertical-align:top;"><div style="width:70px;height:70px;background:#f0f0f0;border-radius:4px;"></div></td><td style="padding-left:10px;vertical-align:top;"><strong style="font-size:14px;">Compelling headline</strong><br/><span style="color:#666;font-size:13px;">Write engaging and informative content.</span><br/><a href="#" style="color:#4caf50;font-size:13px;">Read more</a></td></tr></table>'
            }
          }
        ]
      },
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<p style="color:#555;font-style:italic;font-size:14px;line-height:1.5;">&ldquo;Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam platea fusce eget viverra integer et. Et laoreet enim urna, id. At phasellus cursus purus pretium suspendisse ultricies.&rdquo;</p>',
              padding: '10px 20px'
            }
          },
          {
            type: 'text',
            values: {
              text: '<table cellpadding="0" cellspacing="0"><tr><td style="width:36px;"><div style="width:30px;height:30px;background:#e0e0e0;border-radius:50%;"></div></td><td style="padding-left:10px;"><strong style="font-size:14px;">Fabricio Texeira</strong><br/><span style="color:#999;font-size:12px;">Jan 18</span></td></tr></table>',
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<table cellpadding="0" cellspacing="0" style="width:100%;"><tr><td style="width:50px;vertical-align:top;"><div style="width:40px;height:40px;background:#e0e0e0;border-radius:50%;"></div></td><td style="padding-left:12px;vertical-align:top;"><strong style="font-size:15px;">Author name</strong><br/><span style="color:#666;font-size:13px;">Write engaging and informative content that will help your readers understand your message.</span></td></tr></table>'
            }
          }
        ]
      }
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<p style="font-weight:bold;font-size:16px;">NASA, Rocket Lab Announce Coverage for Second TROPICS Launch</p><p style="color:#666;font-size:13px;margin-top:6px;">After successfully launching the first pair of small satellites earlier this month from New Zealand, NASA and Rocket Lab are now targeting no earlier than 1:00 a.m. EDT Monday, May 23 (5:00 p.m. NZST), to launch the second pair of storm-tracking CubeSats into orbit.</p>'
            }
          }
        ]
      }
    ...
    columns: [
      {
        contents: [
          {
            type: 'text',
            values: { text: '<p style="text-align:center;font-weight:bold;font-size:16px;">Follow us on social</p>' }
          },
          { type: 'social', values: { align: 'center', icons: { iconType: 'circle' } } }
        ]
      }
    ],
    values: { backgroundColor: '#ffffff', padding: '20px' }
    ...
    columns: [
      {
        contents: [
          {
            type: 'text',
            values: { text: '<p style="text-align:center;font-size:14px;">Do you like the newsletter? Share it!</p>' }
          },
          { type: 'social', values: { align: 'center', icons: { iconType: 'circle' } } }
        ]
      }
  ...
  'ftr-centered': {
    ...
    columns: [
      {
        contents: [
          { type: 'image', values: { src: { url: '' }, alt: 'Logo', width: '80px', textAlign: 'center' } },
          { type: 'social', values: { align: 'center', icons: { iconType: 'circle' } } },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:center;"><strong>Company name</strong><br/><span style="font-size:12px;color:#999;">Add your company postal address here</span></p><p style="text-align:center;font-size:11px;color:#999;">You received this email because you signed up on our website or made a purchase from us.</p><p style="text-align:center;"><a href="{{ UnsubscribeURL . }}" style="font-size:12px;">Unsubscribe</a></p>'
            }
          }
        ]
      }
    ],
    values: { backgroundColor: '#f5f5f5', padding: '25px 20px' }
  },
  'ftr-basic': {
    cells: [1, 1],
    columns: [
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<p><strong>Company name</strong><br/><span style="font-size:12px;color:#999;">Add your company postal address here</span></p>'
            }
          },
          { type: 'social', values: { align: 'left', icons: { iconType: 'circle' } } }
        ]
      },
      {
        contents: [
          {
            type: 'text',
            values: {
              text: '<p style="font-size:11px;color:#999;">You received this email because you signed up on our website or made a purchase from us.</p><p><a href="{{ UnsubscribeURL . }}" style="font-size:12px;">Unsubscribe</a></p>'
            }
          }
        ]
      }
        ...
        contents: [
          {
            type: 'text',
            values: {
              text: '<table cellpadding="0" cellspacing="0" style="width:100%;"><tr><td style="vertical-align:middle;"><table cellpadding="0" cellspacing="0"><tr><td style="width:30px;"><div style="width:24px;height:24px;background:#4caf50;border-radius:50%;"></div></td><td style="padding-left:8px;"><strong style="font-size:14px;">Company</strong></td></tr></table></td><td style="text-align:right;vertical-align:middle;"><span style="font-size:20px;">● ● ●</span></td></tr></table>'
            }
          },
          {
            type: 'text',
            values: {
              text: '<p><strong>Company name</strong><br/><span style="font-size:12px;color:#999;">Add your company postal address here</span></p><p style="font-size:11px;color:#999;">You received this email because you signed up on our website or made a purchase from us.</p><p><a href="{{ UnsubscribeURL . }}" style="font-size:12px;">Unsubscribe</a></p>'
            }
          }
        ]
      }
    ],
    values: { backgroundColor: '#f5f5f5', padding: '20px' }
  },
  'ftr-nav': {
    cells: [1],
    columns: [
      {
        contents: [
          { type: 'social', values: { align: 'center', icons: { iconType: 'circle', color: '#ffffff' } } },
          {
            type: 'menu',
            values: {
              layout: 'horizontal',
    ...
    values: { backgroundColor: '#f5f5f5', padding: '0' }
  },
  'ftr-app': {
    cells: [1],
    columns: [
      {
        contents: [
          ...
          },
          {
            type: 'text',
            values: {
              text: '<p style="text-align:left;display:inline-block;"><a href="{{ UnsubscribeURL . }}" style="font-size:12px;">Unsubscribe</a></p>'
            }
          },
          { type: 'social', values: { align: 'right', icons: { iconType: 'circle' } } }
        ]
      }
    ],
    values: { backgroundColor: '#f5f5f5', padding: '25px 20px' }
