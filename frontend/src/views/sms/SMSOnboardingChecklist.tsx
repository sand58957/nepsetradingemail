...
const steps: ChecklistStep[] = [
  {
    ...
    description: 'Set up your Aakash SMS API credentials to start sending SMS messages to your contacts.',
    buttonLabel: 'Configure SMS',
    buttonUrl: '/sms/settings',
    icon: 'tabler-message'
  },
  {
    id: 'import_contacts',
    title: 'Import your contacts',
    description: 'Upload your contact list via CSV or add contacts manually to build your SMS audience.',
    buttonLabel: 'Import contacts',
    buttonUrl: '/sms/contacts/import',
    icon: 'tabler-users-plus'
  },
  {
    id: 'create_group',
    title: 'Create a contact group',
    description: 'Organize your contacts into groups for targeted SMS campaigns.',
    buttonLabel: 'Create group',
    buttonUrl: '/sms/groups',
    icon: 'tabler-users-group'
  },
  {
    id: 'send_campaign',
    title: 'Send your first campaign',
    description: 'Create and send your first SMS marketing campaign to engage with your audience.',
    buttonLabel: 'Create campaign',
    buttonUrl: '/sms/campaigns/create',
    icon: 'tabler-send'
  }
]

const getStorageKey = (accountId: number | null) => `sms_onboarding_${accountId || 'default'}`

const SMSOnboardingChecklist = () => {
        ...
        <Box sx={{ display: 'flex', gap: { xs: 4, md: 8 }, flexDirection: { xs: 'column', md: 'row' } }}>
          ...
          <Box sx={{ flex: '0 0 auto', maxWidth: { md: 280 } }}>
            <Typography variant='h5' fontWeight={700} sx={{ mb: 1 }}>
              Let&apos;s get you started with SMS Marketing
            </Typography>
            <Typography variant='body2' color='text.secondary' sx={{ mb: 3 }}>
              Use this personalised guide to start your SMS marketing journey.
            </Typography>
                  ...
                  >
                    <Box
                      sx={{
                        ...
                        flexShrink: 0,
                        bgcolor: isCompleted ? 'primary.main' : 'action.selected',
                        color: isCompleted ? 'primary.contrastText' : 'text.secondary',
                        fontSize: '0.875rem',
                        fontWeight: 600
                      }}
                    >
...
export default SMSOnboardingChecklist
